...
namespace RR
{
    namespace Tests
    {
        ...
        GAPI::GpuResourceDescription TestContextFixture::createResTexDescription(GAPI::GpuResourceDimension dimension, uint32_t size, GAPI::GpuResourceFormat format, GAPI::GpuResourceUsage usage)
        {
