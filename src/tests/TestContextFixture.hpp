...
namespace RR
{
    ...
    namespace Tests
    {
        ...
        protected:
            ...
            std::shared_ptr<GAPI::Buffer> createBufferFromString(const char* data, const std::string& name, GAPI::GpuResourceBindFlags bindFlags = GAPI::GpuResourceBindFlags::ShaderResource);
