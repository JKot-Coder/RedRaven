...
namespace RR
{
    namespace Tests
    {
        ...
        protected:
            GAPI::GpuResourceDescription createTexureDescription(GAPI::GpuResourceDimension dimension, uint32_t size, GAPI::GpuResourceFormat format, GAPI::GpuResourceUsage usage);
