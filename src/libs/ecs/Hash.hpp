...
namespace RR::Ecs
{
    ...
    namespace details
    {
        constexpr inline HashType HashImpl(const char* str, uint32_t len) { return RR::Common::Hash::Wyhash::Hash<64>(str, len); }
        constexpr inline HashType HashImpl(const void* data, uint32_t len) { return RR::Common::Hash::Wyhash::Hash<64>(data, len); }
        constexpr inline HashType ConstexprHashImpl(const char* str, uint32_t len) { return RR::Common::Hash::Wyhash::ForceConstexprHash<64>(str, len); }
    }
