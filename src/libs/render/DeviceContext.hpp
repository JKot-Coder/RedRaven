...
namespace RR
{
    namespace Render
    {
        ...
        public:
            ...
            std::shared_ptr<GAPI::Buffer> CreateBuffer(const GAPI::GpuResourceDescription& desc, IDataBuffer::SharedPtr initialData = nullptr, GAPI::GpuResourceUsage usage = GAPI::GpuResourceUsage::Default, const U8String& name = "") const;
            ...
            std::shared_ptr<GAPI::Texture> CreateTexture(const GAPI::GpuResourceDescription& desc, IDataBuffer::SharedPtr initialData = nullptr, GAPI::GpuResourceUsage usage = GAPI::GpuResourceUsage::Default, const U8String& name = "") const;
