...
namespace RR
{
    namespace GAPI
    {
        ...
        public:
            ...
            virtual void InitTexture(const std::shared_ptr<Texture>& resource) const = 0;
        ...
        public:
            ...
            void InitTexture(const std::shared_ptr<Texture>& resource) const override { GetPrivateImpl()->InitTexture(resource); };
